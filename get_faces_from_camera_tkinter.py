...
class Face_Register:
    def __init__(self):
        ...
        self.path_photos_from_camera = "data_dlib/data_faces_from_camera/"
    ...
    def GUI_clear_data(self):
        ...
        if os.path.isfile("data_dlib/features_all.csv"):
            os.remove("data_dlib/features_all.csv")
    ...
    def check_existing_faces_cnt(self):
        if os.listdir("data_dlib/data_faces_from_camera/"):
            # Get the order of latest person
            person_list = os.listdir("data_dlib/data_faces_from_camera/")
            person_num_list = []
